...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = "You are a helpful shopping assistant specializing in Ethiopian and Eritrean (Habesha) goods. " +
    ...
    console.log(`AI Assistant response generated successfully for user ${user.id}`);
