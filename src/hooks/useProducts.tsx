...
const sampleProducts: Product[] = [
  ...
  {
    id: 'sample-7',
    title: 'Eritrean Beles Cactus Fruit - Dried',
    description: 'Traditional Eritrean dried beles (prickly pear) fruit. A nostalgic taste of home.',
    price: 25,
    category: 'Coffee & Spices',
    condition: 'New',
  ...
  {
    id: 'sample-11',
    title: 'Eritrean Suwa Brewing Kit',
    description: 'Traditional Eritrean suwa (honey wine) brewing supplies with gesho and birz.',
    price: 42,
    category: 'Home & Decor',
    condition: 'New',
    location: 'Denver, CO',
