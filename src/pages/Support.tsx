        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-card rounded-lg border p-6">
              ...
              <div className="space-y-3">
                <button className="text-foreground hover:underline block">Order Status & Tracking</button>
                <button className="text-foreground hover:underline block">Returns & Exchanges</button>
                <button className="text-foreground hover:underline block">Payment Issues</button>
                <button className="text-foreground hover:underline block">Account Settings</button>
              </div>
            </div>
          </div>
        </div>
